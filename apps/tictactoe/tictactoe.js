...
function verticalWin() {
    return ($('[data-cell="0"]').text() === playerTurn) && ($('[data-cell="4"]').text() === playerTurn) && ($('[data-cell="7"]').text() === playerTurn) ||
           ($('[data-cell="2"]').text() === playerTurn) && ($('[data-cell="5"]').text() === playerTurn) && ($('[data-cell="8"]').text() === playerTurn) ||
           ($('[data-cell="3"]').text() === playerTurn) && ($('[data-cell="6"]').text() === playerTurn) && ($('[data-cell="9"]').text() === playerTurn)
};

function diagonalWin() {
    return ($('[data-cell="1"]').text() === playerTurn) && ($('[data-cell="5"]').text() === playerTurn) && ($('[data-cell="9"]').text() === playerTurn)|| 
